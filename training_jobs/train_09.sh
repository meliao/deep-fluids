...
#SBATCH --time=4:00:00
#SBATCH --output=slurm_logs/09_smoke3_vel_buo3_f250.out
#SBATCH --error=slurm_logs/09_smoke3_vel_buo3_f250.err
...
mkdir -p predictions/long_run-100-epochs
mv log/smoke3_vel5_buo3_f250/0324_110822_de_tag/0_0/ predictions/long_run-100-epochs
...
mv log/smoke3_vel5_buo3_f250/0324_110822_de_tag/10_2/ predictions/long_run-100-epochs
